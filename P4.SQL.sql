...
INSERT INTO `course` VALUES ('C101','Intro to CS',3),('C102','Calculus I',4),('C103','Physics I',4);
...
INSERT INTO `course_instructor` VALUES (1,'C101',10),(1,'C101',11),(2,'C101',10),(2,'C101',11),(1,'C102',11),(3,'C103',12);
...
INSERT INTO `enrollment` VALUES (1,'C101','2025-09-01'),(2,'C101','2025-09-03'),(1,'C102','2025-09-02'),(3,'C103','2025-09-04');
...
INSERT INTO `student` VALUES (1,'Alice Smith','Computer Science'),(2,'Bob Jones','Mathematics'),(3,'Carol Lee','Physics');
...
--
-- Table structure for table `uni_denorm`
--

DROP TABLE IF EXISTS `uni_denorm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `uni_denorm` (
  `StudentID` int DEFAULT NULL,
  `StudentName` text,
  `Major` text,
  `CourseID` text,
...
-- Dump completed on 2025-10-13 16:12:33
